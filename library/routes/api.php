...
Route::middleware('auth.basic')->group(function () {
    ...
    //ellenörött beszúrás
    Route::post('lending_first/{title}/{author}/{copy_id}', [LendingController::class, 'lendingFirst']);
    Route::post('lending_insert_try/{copy_id}', [LendingController::class, 'lendingInsertTry']);
    Route::post('reservation_insert_try/{book_id}', [ReservationController::class, 'reservationInsertTry']);
    Route::post('notice_insert/{copy_id}', [LendingController::class, 'noticeInsert']);
    //trigger
